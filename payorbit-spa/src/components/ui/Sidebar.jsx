...
// Minimal cva replacement for variants
function sidebarMenuButtonVariants({ variant, size } = {}) {
  let base =
  ...
  if (size === "sm") base += " h-7 text-xs"
  else if (size === "lg") base += " h-12 text-sm group-data-[collapsible=icon]:!p-0"
  else base += " h-8 text-sm"
  return base
}
